...
namespace Peaky.Tests
{
    public class PeakyTestDependencyTests
    {
        ...
        public void Target_environment_is_available_by_declaring_a_dependency_on_Target_when_no_resolver_is_specified()
        {
            ...
            Console.WriteLine(api.CreateHttpClient().GetAsync("http://blammo.com/tests/staging/widgetapi/").Result.Content.ReadAsStringAsync().Result);
        ...
        {
            // FIX: (Test_targets_require_absolute_URIs) 
